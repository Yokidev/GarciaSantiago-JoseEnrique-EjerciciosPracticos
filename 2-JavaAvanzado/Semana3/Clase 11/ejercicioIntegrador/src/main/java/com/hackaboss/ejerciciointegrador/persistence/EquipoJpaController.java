    ...
    public void create(Equipo equipo) {
        ...
        try {
            ...
            for (Partido listaPartidosPartidoToAttach : equipo.getListaPartidos()) {
                listaPartidosPartidoToAttach = em.getReference(listaPartidosPartidoToAttach.getClass(), listaPartidosPartidoToAttach.getId());
    ...
    public void edit(Equipo equipo) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Partido listaPartidosNewPartidoToAttach : listaPartidosNew) {
                listaPartidosNewPartidoToAttach = em.getReference(listaPartidosNewPartidoToAttach.getClass(), listaPartidosNewPartidoToAttach.getId());
